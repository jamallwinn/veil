 ...
 *
 * Usage:
 * npx hardhat run scripts/deploy.ts --network xrplEvmTestnet
 */
...
const networkConfigs: Record<string, NetworkConfig> = {
  ...
  xrplEvmMainnet: {
    wXRPToken: "0x0000000000000000000000000000000000000000", // Uses native XRP
    denomination: ethers.parseEther("1"), // 1 XRP - MVP/demo friendly
    name: "XRPL EVM Mainnet",
  },
  // XRPL EVM Testnet
  xrplEvmTestnet: {
    wXRPToken: "0x0000000000000000000000000000000000000000", // TBD: Axelar wXRP on testnet
    denomination: ethers.parseEther("1"), // 1 XRP - for testing
    name: "XRPL EVM Testnet",
  },
  // XRPL EVM Devnet
  xrplEvmDevnet: {
    wXRPToken: "0x0000000000000000000000000000000000000000", // TBD: Axelar wXRP on devnet
    denomination: ethers.parseEther("1"), // 1 XRP - for testing
